...
**** Enable
     ...
     (add-hook 'after-make-frame-functions
               (lambda (_frame)
                 (safe-set-frame-font "Noto Sans Mono:pixelsize=17:weight=medium:slant=normal:width=normal")))

     ;; (safe-set-frame-font "Anonymous Pro:pixelsize=22:weight=bold:slant=normal:width=normal")))
     ;; (safe-set-frame-font "APL385 Unicode:pixelsize=23:weight=regular:normal=normal:width=normal")))
     ;; (safe-set-frame-font "Spleen 32x64:pixelsize=23:weight=medium:slant=normal:width=normal")))
     ;; (safe-set-frame-font "Courier:pixelsize=20:weight=bold:slant=normal:width=normal")))
     ;; (safe-set-frame-font "unscii:pixelsize=22:weight=thin:slant=normal:width=normal")))
     ;; (safe-set-frame-font "Noto Sans Mono:pixelsize=19:weight=bold:slant=normal:width=normal")))
...
***** Customize
      ...
      ;; if non-nil, partial-completion behaves as
      ;; if each word is preceded by wildcard.
      (customize-set-variable 'completion-pcm-leading-wildcard t)
      ...
      ;; (customize-set-variable 'completion-styles '(basic emacs22 orderless))
      ;; (customize-set-variable 'completion-styles '(basic emacs22 partial-completion initials orderless))
      (customize-set-variable 'completion-styles '(emacs22 orderless))
      ...
      (customize-set-variable 'echo-keystrokes 1)

      ;; maximum height for resizing mini-windows
      (customize-set-variable 'max-mini-window-height 0.3)

      ;; this flag controls how an input method shows an intermediate
      ;; key sequence
      (customize-set-variable 'input-method-use-echo-area t)
      ...
      ;; special hook to find the completion table
      ;; for the entity at point (default)
      ;; `(elisp-completion-at-point tags-completion-at-point-function t))
      (customize-set-variable 'completion-at-point-functions '(t))
...
***** Customize
      ...
      (customize-set-variable 'completion-on-separator-character nil)
...
***** Binds
      ...
      ;; bind completion at point again
...
***** Binds
      ...
      (eval-after-load 'edm
        (lambda ()
          ...
          ;; minibuffer
          (define-key minibuffer-local-map (kbd "M-`") 'edm-display-menu-buffer)
          ;; ctl-x-map
...
***** Customize
      ...
      (customize-set-variable 'icomplete-compute-delay 0.2)
      ...
      (customize-set-variable 'icomplete-prospects-height 4)
      ...
      (customize-set-variable 'icomplete-in-buffer t)

      ;; By default, when you press ‘C-M-i’, both Icomplete mode's in-buffer
      ;; display of possible completions and the ‘*Completions*’ buffer appear.
      ;; If you are using ‘icomplete-in-buffer’, then you may wish to suppress
      ;; this appearance of the ‘*Completions*’ buffer.
...
***** Binds
      ...
      (define-key ctl-x-map (kbd "C-u") 'undo-tree-visualize)
...
****** Binds
       ...
       (define-key ctl-x-map (kbd "]") 'multi-term-dedicated-toggle)
       (define-key ctl-x-map (kbd "C-]") 'multi-term-dedicated-toggle)
...
***** Customize
      ...
      ;; preview currently selected candidate, if the variable
      ;; has the value 'insert the candidate is automatically
      ...
      (customize-set-variable 'corfu-preselect 'prompt)

      ;; configure how a single exact match should be handled
      (customize-set-variable 'corfu-on-exact-match 'show)

      ;; delay for auto completion.Delay for auto completion
      (customize-set-variable 'corfu-auto-delay 0.2)

      ;; minimum length of prefix for auto completion
      (customize-set-variable 'corfu-auto-prefix 2)

      ;; maximal number of candidates to show
      (customize-set-variable 'corfu-count 8)
      ...
      (eval-after-load 'corfu-mode
        (lambda ()
          (when (boundp 'corfu-map)
            ...
            (define-key corfu-map (kbd "M-DEL") 'corfu-previous))))
      ...
      (add-hook 'corfu-mode-hook
                (lambda ()
                  (when (fboundp 'corfu-terminal-mode)
                    (funcall #'(lambda () (corfu-terminal-mode +1))))))
...
***** Customize
      ...
      ;; use popon ui on gui
      (customize-set-variable 'corfu-terminal-disable-on-gui nil)

      ;; non-nil means enable corfu-terminal on minibuffer
      (customize-set-variable 'corfu-terminal-enable-on-minibuffer nil)
...
***** Customize
      ...
      (customize-set-variable 'emms-source-file-default-directory
                              (expand-file-name "~/media/music/Playlist/"))
...
***** Customize
      ...
      ;; whether gud should highlight the source line being debugged. hide
      ...
      (customize-set-variable 'gud-highlight-current-line t)

      ;; default command to run an executable under GDB in text command mode
      (customize-set-variable 'gud-gud-gdb-command-name "gdb -f")
...
***** Customize
      ...
      (customize-set-variable 'gdb-show-main nil)
...
***** Customize
      ...
      (customize-set-variable 'rmsbolt-asm-format t)
...
***** Customize
      ...
      (customize-set-variable 'eglot-code-action-indications
                              '(eldoc-hint))

      ;; indicator string for code action suggestions
      (customize-set-variable 'eglot-code-action-indicator "→")
      ...
      (customize-set-variable 'eglot-advertise-cancellation t)
      ...
      (customize-set-variable 'eglot-connect-timeout 15)
...
***** Customize
      ...
      (customize-set-variable 'python-shell-virtualenv-root "~/.local/python/project/venv")
